...
from simvp.models.simvp_wavelets import DWT_2D_FFT_L2
...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        self.norm = nn.BatchNorm2d(num_features=4)
        self.act = nn.ReLU()
        ######################################

        self.enc = Encoder(C*4, hid_S, N_S, spatio_kernel_enc)
...
class MetaBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, input_resolution=None, model_type=None,
        ...
        ################# updated ##################
        elif model_type == 'sfaxvit':
            self.block = SfavitSubBlock(
                dim=in_channels,
                dim_out=in_channels,
                num_heads=32, mlp_ratio=mlp_ratio,
                drop_path=drop_path)
        ###########################################
