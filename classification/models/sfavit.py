...
from .sfavit_wavelets import DWT_2D_FFT_L2

__all__ = ['SFAVitCfg', 'SFAVitConvCfg', 'SFAVitTransformerCfg', 'SFAVit']
...
class SFAVitCfg:
    ...
    conv_cfg: SFAVitConvCfg = field(default_factory=SFAVitConvCfg)
    transformer_cfg: SFAVitTransformerCfg = field(default_factory=SFAVitTransformerCfg)
...
class MbConvBlock(nn.Module):
    def __init__(
            ...
            cfg: SFAVitConvCfg = SFAVitConvCfg(),
            drop_path: float = 0.
    ):
...
def get_rel_pos_cls(cfg: SFAVitTransformerCfg, window_size):
    rel_pos_cls = None
...
class PartitionAttentionCl(nn.Module):
    ...
    def __init__(
            ...
            cfg: SFAVitTransformerCfg = SFAVitTransformerCfg(),
            drop_path: float = 0.,
    ):
        super().__init__()
...
class SFAVitBlock(nn.Module):
    ...
    def __init__(
            ...
            num_heads: int,
            stride: int = 1,
            conv_cfg: SFAVitConvCfg = SFAVitConvCfg(),
            transformer_cfg: SFAVitTransformerCfg = SFAVitTransformerCfg(),
            drop_path: float = 0.,
            mlp_ratio: float = 4.,
            layer: int = 0,
    ):
...
def cfg_window_size(cfg: SFAVitTransformerCfg, img_size: Tuple[int, int]):
...
def _overlay_kwargs(cfg: SFAVitCfg, **kwargs):
    transformer_kwargs = {}
    conv_kwargs = {}
    base_kwargs = {}
...
class SFAVit(nn.Module):
    def __init__(
            self,
            cfg: SFAVitCfg = "SFAViT_Tiny",
...
def _create_sfavit(variant, cfg_variant=None, pretrained=False, **kwargs):
...
default_cfgs = generate_default_cfgs({
    'sfavit_p1_224.in1k': _cfg(
        file='/path/to/checkpoint', 
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD, crop_pct=0.875),
    
    'sfavit_p2_224.in1k': _cfg(
        file='/path/to/checkpoint', 
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD, crop_pct=0.875), 
    
    'sfavit_n_224.in1k': _cfg(
        file='/path/to/checkpoint', 
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD, crop_pct=0.875),
    
    'sfavit_t_224.in1k': _cfg(
        file='/path/to/checkpoint', 
...
model_cfgs = dict(
        sfavit_p0_224=SFAVitCfg(
            ...
            transformer_cfg=SFAVitTransformerCfg(
                dim_head = 12,
            )
        ),
        sfavit_p1_224=SFAVitCfg(
...
if classification:
    ...
    @register_model
    def sfavit_p0_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_p0_224', 'sfavit_p0_224', pretrained=pretrained, **kwargs)
    
    @register_model
    def sfavit_p0_256(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_p0_256', 'sfavit_p0_256', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_p1_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_p1_224', 'sfavit_p1_224', pretrained=pretrained, **kwargs)
    
    @register_model
    def sfavit_p1_256(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_p1_256', 'sfavit_p1_256', pretrained=pretrained, **kwargs)

    @register_model
    def sfavit_p2_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_p2_224', 'sfavit_p2_224', pretrained=pretrained, **kwargs)
    
    @register_model
    def sfavit_n_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_n_224', 'sfavit_n_224', pretrained=pretrained, **kwargs)
    
    @register_model
    def sfavit_t_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_t_224', 'sfavit_t_224', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_t_384(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_t_384', 'sfavit_t_384', pretrained=pretrained, **kwargs)

    @register_model
    def sfavit_s_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_s_224', 'sfavit_s_224', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_s_384(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_s_384', 'sfavit_s_384', pretrained=pretrained, **kwargs)

    @register_model
    def sfavit_m_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_m_224', 'sfavit_m_224', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_m_384(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_m_384', 'sfavit_m_384', pretrained=pretrained, **kwargs)

    @register_model
    def sfavit_b_224(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_b_224', 'sfavit_b_224', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_b_256(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_b_256', 'sfavit_b_256', pretrained=pretrained, **kwargs)
    @register_model
    def sfavit_b_384(pretrained=False, **kwargs) -> SFAVit:
        return _create_sfavit('sfavit_b_384', 'sfavit_b_384', pretrained=pretrained, **kwargs)
    
else:
    if mmpose:
        @MODELS.register_module()
        class SFAVit_feat(SFAVit):
